...
<div class="row">
  <div class="col-sm mt-3 mt-md-0 d-flex justify-content-center">
    {% include figure.liquid loading="eager" path="assets/img/FGS1.png" 
       ...
       class="img-fluid rounded z-depth-1" style="max-height: 375px; width: auto; height: 100%; object-fit: contain;" %}
  </div>
</div>
<div class="caption">
...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/AIRS.png" 
       ...
       class="img-fluid rounded z-depth-1" style="height: 375px; width: 100%; object-fit: cover;" %}
  </div>
</div>
<div class="caption">
